using TemplateArchDemo.Application.Common.Models;
using TemplateArchDemo.Application.TodoItems.Commands.CreateTodoItem;
using TemplateArchDemo.Application.TodoItems.Commands.DeleteTodoItem;
using TemplateArchDemo.Application.TodoItems.Commands.UpdateTodoItem;
using TemplateArchDemo.Application.TodoItems.Commands.UpdateTodoItemDetail;
using TemplateArchDemo.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace TemplateArchDemo.Web.Endpoints;
